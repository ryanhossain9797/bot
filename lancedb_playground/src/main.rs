...
fn raw_turns() -> Vec<String> {
    [
        ...
        "USER MESSAGE: Zireael9797 (id:404941793076051968): Qwen 35B-A3B on a Strix Halo with 96GB of unified memory",
        "MESSAGE USER: A Strix Halo with 96GB is a solid fit for a 35B-A3B model.",
...
fn distilled_facts() -> Vec<String> {
    [
        ...
        "The user runs Qwen 35B-A3B on a Strix Halo with 96GB of unified memory.",
